        ...
        <footer className="site-footer">
            <div className="container">
                <div className="footer-column footer-about">
                    <h3 className="footer-title">Về GlassStore</h3>
                ...
                <div className="footer-column footer-contact">
                    ...
                    <p><i className="fas fa-phone"></i> Hotline: 0999999999</p>
                    <p><i className="fas fa-envelope"></i> Email: support@glassstore.com</p>
            ...
            <div className="footer-bottom">
                <p>&copy; 2025 GLASSSTORE. All Rights Reserved.</p>
            </div>
        </footer>
    );
};
